...
const structure = [
  ...
  {id: 1, label: "Schools", link: "/admin/schools", icon: <Apartment />},
  {id: 2, label: "AR requests", link: "/admin/ar", icon: <AR /> },
  {id: 3,label: "Live Stream",link: "/admin/live",icon: <Stream />},
  {id: 4,label: "Reviews and Feedbacks",link: "/admin/reviews",icon: <UIElementsIcon />},
];
